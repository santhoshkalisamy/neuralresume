        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="py-16">
                <div className="flex justify-center gap-x-6">
                    <Link href="/" className="text-teal-500 font-extrabold">NeuralResume</Link>
                </div>
            ...
            <div
                ...
                <div className="flex gap-x-6"><a className="group" aria-label="TaxPal on X" href="#">
                    <svg className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700" aria-hidden="true"
                         viewBox="0 0 24 24">
                        <path
                ...
                </a><a className="group" aria-label="TaxPal on GitHub" href="#">
                    <svg className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700" aria-hidden="true"
                         viewBox="0 0 24 24">
                        <path
                ...
                <p className="mt-6 text-sm text-slate-500 sm:mt-0">Copyright © 2024 NeuralResume. All rights
                    reserved.</p></div>
        </div>
    )
}
